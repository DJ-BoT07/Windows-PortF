...
export function Taskbar({ toggleStartMenu, windows, focusWindow }) {
  return (
    <div className="h-12 bg-gradient-to-r from-[#245edb] via-[#3a6ee8] to-[#245edb] flex items-center px-1 shadow-md">
      <Button
        variant="ghost"
        className="h-10 px-2 rounded-none bg-gradient-to-r from-[#378a4c] via-[#5eb06d] to-[#378a4c] text-white font-bold hover:bg-[#74b2ff] hover:text-white focus:bg-[#74b2ff] focus:text-white border-r border-[#2d7345] shadow-inner flex items-center"
        onClick={toggleStartMenu}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="12 -12 48 48" className="mr-2">
